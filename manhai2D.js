...
(function (global, factory) {
	...
	Object.assign(Camera.prototype, {
		...
		setArrayMap: function(map, colum, row)
		{
			this.arrayMap = map;
		...
		{
			//decoderArray is a two-dimentional array where the 1st element is the code in the arrayMap and the 2nd the code to run in form of a string
